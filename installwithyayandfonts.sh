...
install_packages() {
  ...
  # Install Nerd Fonts (52, 28, 42) manually
  echo "Installing Nerd Fonts (52, 28, 42)..."

  # Create a directory for Nerd Fonts
  mkdir -p $HOME/.local/share/fonts

  # Download the font zip files
  curl -L -o $HOME/.local/share/fonts/nerd-fonts-52.zip https://github.com/ryanoasis/nerd-fonts/releases/download/v2.1.0/UbuntuMono.zip
  curl -L -o $HOME/.local/share/fonts/nerd-fonts-28.zip https://github.com/ryanoasis/nerd-fonts/releases/download/v2.1.0/SourceCodePro.zip
  curl -L -o $HOME/.local/share/fonts/nerd-fonts-42.zip https://github.com/ryanoasis/nerd-fonts/releases/download/v2.1.0/FiraCode.zip

  # Unzip the downloaded files
  unzip $HOME/.local/share/fonts/nerd-fonts-52.zip -d $HOME/.local/share/fonts/
  unzip $HOME/.local/share/fonts/nerd-fonts-28.zip -d $HOME/.local/share/fonts/
  unzip $HOME/.local/share/fonts/nerd-fonts-42.zip -d $HOME/.local/share/fonts/

  # Clean up zip files
  rm $HOME/.local/share/fonts/nerd-fonts-52.zip
  rm $HOME/.local/share/fonts/nerd-fonts-28.zip
  rm $HOME/.local/share/fonts/nerd-fonts-42.zip
