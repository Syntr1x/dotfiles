...
waybar_colors=("#d8c8b3" "#888888" "#f0a0c0" "#a1cdf3" "#fed79d" "#d8c8b3" "#fdcbe6" "#FB443C" "#FDE094" "#8c9180" "#C0884B" "#f0a0c0")
...
set_sddm_wallpaper() {
  ...
  sudo sed -i "s/^background = \".*\"/background = \"$wallpaper\"/" /usr/share/sddm/themes/silent/configs/defaultsyn.conf
  echo -e "${GREEN}✓ SDDM wallpaper set to $wallpaper${RESET}"
}
...
idx=$(get_selection "Choose wallpaper" wallpapers) && set_wallpaper "$idx" && set_sddm_wallpaper "$idx"
