...
install_pacman_packages() {
  local REQUIRED_PKGS=("waybar" "rofi" "hyprland" "nano" "ghostty" "hyprpaper" "dolphin" "ark" "fastfetch" "btop" "ttf-nerd-fonts-symbols" "ttf-font-awesome" "networkmanager" "flatpak" "kitty" "wget" "reflector" "dunst")
...
copy_configs() {
  ...
  sudo cp /home/$USER/tempconf/defaultsyn.conf /usr/share/sddm/silent/configs/
