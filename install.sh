...
copy_configs() {
  ...
  mkdir ~/.config/waybar
  sudo cp -r ~/archconfig/waybar ~/.config/
  sudo cp -r ~/archconfig/hypr ~/.config/
  sudo cp -r ~/archconfig/Rofi-themes/rounded-common.rasi /usr/share/rofi/themes
  sudo cp -r ~/archconfig/Rofi-themes/rounded-dark-beige.rasi /usr/share/rofi/themes
}
